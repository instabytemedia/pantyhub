...
export async function GET(request: NextRequest) {
  try {
    ...
    const ALLOWED_SORT_FIELDS = new Set(["username", "email", "password", "role", "created_at", "updated_at"]);
    ...
    if (search) {
      query = query.or(`username.ilike.%${search}%,email.ilike.%${search}%,password.ilike.%${search}%`);
    }
