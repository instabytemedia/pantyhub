...
export async function GET(request: NextRequest) {
  try {
    ...
    const ALLOWED_SORT_FIELDS = new Set(["listing_id", "buyer_id", "seller_id", "amount", "status", "payment_intent_id", "created_at", "updated_at"]);
    ...
    if (search) {
      query = query.or(`payment_intent_id.ilike.%${search}%`);
    }
